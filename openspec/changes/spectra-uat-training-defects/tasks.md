## 1. Produkt und Evidence

- [x] 1.1 UAT-, Training-, Defect- und Exit-Vertrag mit Wahrheitsgrenzen definieren (`contract/uat-training-defects.md`)
- [x] 1.2 Schema, beide Profilgeneratoren, Validator und CLI implementieren (`schemas/uat-training-defects.schema.json`, Automation)
