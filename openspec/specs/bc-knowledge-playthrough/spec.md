# bc-knowledge-playthrough Specification

## Purpose
TBD - created by archiving change spectra-bc-knowledge-playthrough. Update Purpose after archive.
## Requirements
...
Der Consultant-Knowledge-Pack MUST denselben `knowledge_pack_id` wie sein gebundener Reference-Snapshot verwenden. Jede Objektreferenz MUST einen exakten, vorhandenen `object_key` des validierten Objektindex bezeichnen.
