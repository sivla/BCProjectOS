...
$cases=@(
 ...
 @{code='PORTABLE_TICKET_FIELDS';m={param($x)$x.tickets[0].acceptance=@()}},
 @{code='PORTABLE_TICKET_FIELDS';m={param($x)$x.tickets[0].evidence=@()}},
 @{code='PORTABLE_CLOSING_COMMENT';m={param($x)$x.tickets[0].comments=@($x.tickets[0].comments|? type -ne closing)}},
